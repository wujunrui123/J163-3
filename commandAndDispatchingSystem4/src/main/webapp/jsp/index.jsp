		...
		<div class="layui-header header header-demo">
			<div class="layui-main">
				...
				<div class="admin-logo-box">
					<a class="logo" href="http://www.kuxuebao.net" title="logo">医院外派系统</a>
			...
			<div class="layui-side-scroll" id="larry-nav-side" lay-filter="side">
				...
				<ul class="layui-nav layui-nav-tree">
					<li class="layui-nav-item layui-this"><a href="javascript:;"
						data-url="main.html"> <i class="iconfont icon-home1"
							data-icon='icon-home1'></i>
					...
					<!-- 用户管理 -->
					<li class="layui-nav-item"><a href="javascript:;"> <i
							class="iconfont icon-jiaoseguanli2"></i> <span>接收消息</span> <em
							class="layui-nav-more"></em>
					</a>
						<dl class="layui-nav-child">
				
								 <dd><a href="javascript:;" data-url="main.jsp"> <i
									class="iconfont icon-yonghu1" data-icon='icon-yonghu1'></i> <span>查看进度</span>
								</a>
							</dd>
					...
					<!-- 内容管理 -->
					<li class="layui-nav-item"><a href="javascript:;"> <i
							class="iconfont icon-wenzhang1"></i> <span>库存管理</span> <em
							class="layui-nav-more"></em>
					</a>
						<dl class="layui-nav-child">
							<dd>
								...
								<dd>
								<a href="javascript:;" data-url="wuz.jsp"> <i
									class="iconfont icon-lanmuguanli" data-icon='icon-lanmuguanli'></i>
									<span>物资管理</span>
								</a>
							</dd>
					...
					<li class="layui-nav-item"><a href="javascript:;"> <i
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" data-url="../user.lovo"> <i
									class="iconfont icon-zhuti" data-icon='icon-zhuti'></i> <span>用户列表</span>
								</a>
							</dd>
						</dl></li>
			...
			<div class="layui-tab layui-tab-card larry-tab-box" id="larry-tab"
				...
				<div class="layui-tab-content" style="min-height: 150px;">
					<div class="layui-tab-item layui-show">
						...
						<iframe class="larry-iframe" data-id='0' src="PlanTemplate.jsp"></iframe>
						<iframe class="larry-iframe" data-id='0' src="main2.jsp"></iframe>
						<iframe class="larry-iframe" data-id='0' src="main3.jsp"></iframe>
					</div>
				</div>
