					...
					<table class="layui-table">
						<colgroup>
							...
							<a class="layui-btn layui-btn-mini news_edit"
									style="font-size: 18px"><i class="iconfont icon-edit"></i>事件名称:<span style="font-size: 16px">获取</span></a>
					<a class="layui-btn layui-btn-mini news_edit"
								style="font-size: 18px"	><i class="iconfont icon-edit" ></i>事件状态:<span style="font-size: 16px">动态获取,事件状态处理中还是完成</span></a>
						...
						<tbody class="news_content">
							<tr>
								...
								<td><a 
									...
									><i class="iconfont icon-edit"></i>回收</a>
