...
<section class="layui-larry-box">
	<div class="larry-personal">
	    <div class="layui-tab">
				...
				<br>	<br>预案模版名称:<div class="layui-input-inline">
							<input value="" placeholder="输入模版名称名称"
								class="layui-input search_input" type="text">
						</div>
						<br><br>	预案模版类型:<div class="layui-input-inline">
							<select class='sel'>
								<option>群体事件类型</option>
								<option>坍塌事件类型</option>
							</select>
						</div>
					<br><br>	预案模版等级:<div class="layui-input-inline">
							<input value="" placeholder="输入预案模版等级"
								class="layui-input search_input" type="text">
						</div>
					<br><br>	添加医院人数:<div class="layui-input-inline">
							<input value="" placeholder="输入医院人数"
								class="layui-input search_input" type="text">
						</div>
						<br><br>	添加救护车辆:<div class="layui-input-inline">
							<input value="" placeholder="输入救护车辆数量"
								class="layui-input search_input" type="text">
						</div>
						<br><br>	添加消防人数:<div class="layui-input-inline">
							<input value="" placeholder="输入消防人数"
								class="layui-input search_input" type="text">
						</div>
						<br><br>	添加消防车辆:<div class="layui-input-inline">
